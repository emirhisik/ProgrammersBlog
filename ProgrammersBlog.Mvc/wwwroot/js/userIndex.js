                        ...
                        const newTableRow = `
                                <tr name="${categoryAddAjaxModel.CategoryDto.Category.Id}">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger btn-delete btn-sm btn-block" data-id="${categoryAddAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-minus-circle"></span> Sil</button>
                                    </td>
                    ...
                    const newTableRow = `
                                <tr name="${categoryUpdateAjaxModel.CategoryDto.Category.Id}">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger btn-delete btn-sm btn-block" data-id="${categoryUpdateAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-minus-circle"></span> Sil</button>
                                    </td>
